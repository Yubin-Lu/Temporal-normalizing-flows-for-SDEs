...
class neural_flow(nn.Module):
    ...
    def integrate(self, f, dataset, offset_function):
        ...
        # print(integrated.detach().numpy().shape)
        ...
        # print(dataset.grid_data[:, 0:1].detach().numpy().shape)
        return z
    ...
    def sample_grid(self, results_regular_grid, dataset):
        ...
        # print(torch.min(dataset.grid_data, dim=0))
        # print(t_min)
        # print(x_min)
        ...
        # print(normalized_particle_t.shape)
